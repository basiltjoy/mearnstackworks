...
console.log("Currency info:-",countries[0].currencies[0].name, countries[0].currencies[0].symbol)

//prnt languages in india
 console.log(countries[0].languages[0].name,countries[0].languages[1].name);
